...
export default function Edit({ plans, modules }) {
    ...
    const { data, setData, put, processing, errors } = useForm({
        ...
        outlet_range: plans.outlet_range || "0"
    });
            ...
            <div className="max-w-5xl mx-auto">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="bg-white rounded-2xl shadow-sm overflow-hidden border border-gray-200">
                        ...
                        <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                {errors.plan_type && <p className="text-red-600 text-sm mt-2">⚠️ {errors.plan_type}</p>}
                            </div>
                        </div>
                        ...
                        <div className="p-6 border-t border-gray-200 space-y-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                                ...
                                {data.plan_type == '2' && (
                                    <div>
                                        <label className="block text-sm font-semibold text-gray-700 mb-2">
                                            {t('plan.currency', '৳')} {t('plan.price', 'Price')} *
                                        </label>
                                        <input
                                            type="number"
                                            value={data.price}
                                ...
                                <div>
                                    ...
                                    />
                                    {errors.product_range && <p className="text-red-600 text-sm mt-2">⚠️ {errors.product_range}</p>}
                                </div>
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        min="1"
                                    />
                                    {errors.validity && <p className="text-red-600 text-sm mt-2">⚠️ {errors.validity}</p>}
                                </div>
                            </div>
                            ...
                            <div className="md:col-span-2">
                                ...
                                />
                                {errors.description && <p className="text-red-600 text-sm mt-2">⚠️ {errors.description}</p>}
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex justify-end gap-4">
                        ...
                        <button
                            disabled={processing}
                            className={`group flex items-center gap-3 px-8 py-3 rounded-xl font-bold text-white transition-all duration-200
